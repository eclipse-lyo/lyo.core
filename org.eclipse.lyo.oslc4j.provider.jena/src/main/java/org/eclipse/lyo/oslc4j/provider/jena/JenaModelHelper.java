...
public final class JenaModelHelper {
    ...
    private static void handleLocalResource(final Class<?> resourceClass, final Method method,
        ...
        // Doubles need special handling for infinite values.
            ...
            logger.warning(
                    "Could not serialize " + objectClassName + " because it does not have an OslcResourceShape annotation (class: " + subjectClassName + ", method: " + method
                            .getName() + ")");
        }
    ...
    private static void recursivelyCollectNamespaceMappings(
        ...
        if (oslcSchemaAnnotation != null) {
            ...
            Class<? extends IOslcCustomNamespaceProvider> customNamespaceProvider = oslcSchemaAnnotation
                    .customNamespaceProvider();
            if (!customNamespaceProvider.isInterface()) {
                try {
                    IOslcCustomNamespaceProvider customNamespaceProviderImpl = customNamespaceProvider
                            .newInstance();
                    ...
                    throw new RuntimeException(
                            "The custom namespace provider implementation: " + customNamespaceProvider
                                    .getClass()
                                    .getName() + ", must have a public no args construtor", e);
                } catch (InstantiationException e) {
                    throw new RuntimeException(
                            "The custom namespace provider must not be a abstract, nor interface class and " + "must have a public no args constructor",
                            e);
                }
            }
        }
