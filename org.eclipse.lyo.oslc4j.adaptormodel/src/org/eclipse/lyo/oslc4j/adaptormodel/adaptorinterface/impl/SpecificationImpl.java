 ...
 * <ul>
 *   <li>{@link org.eclipse.lyo.oslc4j.adaptormodel.adaptorinterface.impl.SpecificationImpl#getDomainSpecifications <em>Domain Specifications</em>}</li>
 *   <li>{@link org.eclipse.lyo.oslc4j.adaptormodel.adaptorinterface.impl.SpecificationImpl#getDomainPrefixes <em>Domain Prefixes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpecificationImpl extends CDOObjectImpl implements Specification {
	...
	public EList<DomainSpecification> getDomainSpecifications() {
		return (EList<DomainSpecification>)eGet(AdaptorInterfacePackage.Literals.SPECIFICATION__DOMAIN_SPECIFICATIONS, true);
	}
	...
	public EList<NamespacePrefix> getDomainPrefixes() {
		return (EList<NamespacePrefix>)eGet(AdaptorInterfacePackage.Literals.SPECIFICATION__DOMAIN_PREFIXES, true);
	}
