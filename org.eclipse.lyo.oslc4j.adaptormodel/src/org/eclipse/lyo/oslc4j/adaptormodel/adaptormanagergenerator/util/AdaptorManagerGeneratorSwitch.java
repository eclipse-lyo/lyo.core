 ...
 * @generated
 */
public class AdaptorManagerGeneratorSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public AdaptorManagerGeneratorSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AdaptorManagerGeneratorPackage.ADAPTOR_MANAGER_GENERATOR: {
				AdaptorManagerGenerator adaptorManagerGenerator = (AdaptorManagerGenerator)theEObject;
				T result = caseAdaptorManagerGenerator(adaptorManagerGenerator);
				if (result == null) result = caseAdaptorInterfaceGenerator(adaptorManagerGenerator);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Adaptor Manager Generator</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Adaptor Manager Generator</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAdaptorManagerGenerator(AdaptorManagerGenerator object) {
		return null;
	}
