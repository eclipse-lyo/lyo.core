...
public final class ShaclShapeFactory extends ResourceShapeFactory{
	...
	private static ShaclShape createShaclShape(final Class<?> resourceClass,
		...
		//If shacl annotations are available. No need to populate property instance from oslc annotations. 
	 ...
	 */
	private static void populateFromClassLevelAnnotations(ShaclShape shaclShape, final Class<?> resourceClass) throws URISyntaxException {
