...
namespace Org.Eclipse.Lyo.ChangeManagementTest
{
    ...
    public abstract class TestBase
    {
                                                ...
                                                String        type)
        {
            ...
            Org.Eclipse.Lyo.Core.Model.Property[] properties = resourceShape.GetProperties();

            Assert.IsNotNull(properties);
            Assert.IsTrue(properties.Length > 0);

            foreach (Org.Eclipse.Lyo.Core.Model.Property property in properties)
            {
