...
public class LinkTest {
    ...
    @Test
    public void testEqualsDetectsChangedLabel() throws Exception {
        Link linkA = new Link(URI.create(URI_A), LABEL_A);
        Link linkB = new Link(URI.create(URI_A), LABEL_A + "!");

        assertThat(linkA, not(equalTo(linkB)));
    }
